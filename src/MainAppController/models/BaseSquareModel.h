...
struct BaseSquareModel {
  ...
  static constexpr std::array<glm::vec2, kVertexCount> vertices_ = {
      glm::vec2(-kHalfBaseSize, -kHalfBaseSize), glm::vec2(kHalfBaseSize, -kHalfBaseSize),
      glm::vec2(kHalfBaseSize, kHalfBaseSize),   glm::vec2(kHalfBaseSize, kHalfBaseSize),
      glm::vec2(-kHalfBaseSize, kHalfBaseSize),  glm::vec2(-kHalfBaseSize, -kHalfBaseSize),
  };

  static constexpr std::array<glm::vec2, kVertexCount> textures_ = {glm::vec2(0.0F, 0.0F), glm::vec2(1.0F, 0.0F),
